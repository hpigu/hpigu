...
Java 後端工程師，約 7–8 年經驗，主要負責維運與擴充正式環境系統——微服務架構、分散式快取、訊息佇列、MySQL 效能調校。

日常使用 AI 開發工具（Claude Code、Cursor），不只是拿來自動補全，而是實際用在系統規劃與範圍評估上。
...
一套獨立規劃、AI 輔助實作的餐廳管理系統。

- **RBAC** 權限控管（Spring Security + JWT）
- **STOMP 雙層驗證**，用於即時功能
- **三層暴力破解防護**（Bucket4j）
...
積極尋找台北地區的 Java / Spring Boot 資深後端工程師職缺，開放評估金融科技類公司，不考慮博弈相關或純外派型 SI 職缺。
